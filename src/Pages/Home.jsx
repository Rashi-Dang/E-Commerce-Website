...
//             <img src="https://img.freepik.com/free-photo/black-friday-elements-assortment_23-2149074075.jpg" className="absolute block object-fill w-full inset-0 h-full" alt="..."/>
//         </div>
//         {/* <!-- Item 2 --> */}
//         <div className="hidden duration-700 ease-in-out" data-carousel-item>
//             <img src="https://img.freepik.com/free-photo/female-friends-out-shopping-together_53876-25041.jpg?size=626&ext=jpg&ga=GA1.1.44546679.1715817600&semt=sph" className="absolute block object-fill w-full inset-0 h-full" alt="..."/>
//         </div>
//         {/* <!-- Item 3 --> */}
//         <div className="hidden duration-700 ease-in-out" data-carousel-item>
//             <img src="https://t4.ftcdn.net/jpg/03/09/86/97/360_F_309869755_IquCHHxF7YABo2odctUGEjMrgVDSM8qV.jpg" className="absolute block object-fill w-full inset-0 h-full" alt="..."/>
//         </div>
//         {/* <!-- Item 4 --> */}
//         <div className="hidden duration-700 ease-in-out" data-carousel-item>
//             <img src="https://www.wallpapermania.eu/images/lthumbs/2012-08/3391_Girls-at-shopping-fashion-wallpaper.jpg" className="absolute block object-fill w-full inset-0 h-full" alt="..."/>
//         </div>
//         {/* <!-- Item 5 --> */}
//         <div className="hidden duration-700 ease-in-out" data-carousel-item>
//             <img src="https://st2.depositphotos.com/1017986/5966/i/450/depositphotos_59669703-stock-photo-couple-with-smartphone-and-shopping.jpg" className="absolute block object-fill w-full inset-0 h-full" alt="..."/>
//         </div>
//     </div>
//     {/* <!-- Slider indicators --> */}
...
// <div>
// <h1 className='text-black text-center text-4xl m-4'>Products</h1>
//   <div className='flex justify-evenly my-4'>
//     <img src="https://img.freepik.com/premium-photo/cosmetics-products-hd-8k-wallpaper-stock-photographic-image_915071-73605.jpg" alt="" className='w-80 h-80 rounded' />
//     <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTkwbB-qvZ7wqwsYYpVWs4eSvmJFtFKb4d6h4l2b6EXXQ&s" alt="" className='w-80 h-80 rounded' />
//     <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTROltuDKmh-0nj_a4WYuRoTywH5QHQuLYZ0ugoGK85Qg&s" alt="" className='w-80 h-60 rounded' />
//   </div>

//   <div className='flex justify-evenly my-4'>
//     <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_9TqcamXllq17TquiuTt4SD5UXqezLZfRkPIWstkYCQ&s" alt="" className='w-80 h-60 rounded' />
//     <img src="https://media.istockphoto.com/id/909364218/photo/luxury-sparkling-womens-dresses-on-hangers.jpg?s=612x612&w=0&k=20&c=tnbgMif1jspo_o-qLs6Jht7xqkAMdfPRkEm3TTTydwM=" alt="" className='w-80 h-60 rounded' />
//     <img src="https://m.media-amazon.com/images/S/aplus-media-library-service-media/c71a06e5-c438-4a57-b7ed-f4e71fb1f343.__CR0,0,3880,2400_PT0_SX970_V1___.jpg" alt="" className='w-80 h-100 rounded' />
//   </div>
// </div>
  ...
  return (
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        <a href="#" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
            {/* <span class="text-xs bg-amber-500 rounded-full text-white px-4 py-1.5 mr-3">New</span> <span class="text-sm font-medium">Flowbite is out! See what's new</span>  */}
            {/* <svg class="ml-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg> */}
        </a>
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white"> Global Goods </h1>
        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">"Explore a world of quality with Global Goods, your premier destination for international ecommerce."</p>
        <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <Link to="/blogs" href="#" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-amber-500 hover:bg-amber-800 focus:ring-4 focus:ring-amber-300 dark:focus:ring-primary-900">
                Shop Now
                <svg class="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            </Link>
        
            <Link to="/login" href="#" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="max-w-screen-md">
            ...
            <div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
                <Link to="/blogs" href="#" class="inline-flex items-center justify-center px-4 py-2.5 text-base font-medium text-center text-white bg-amber-500 rounded-lg hover:bg-amber-700 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                    Get started
                </Link>
